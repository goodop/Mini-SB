...
class Object(object):
    ...
    def __init__(self):
        if self.isLogin == True:
            self.log("────────────────────────────────────────────────────────────────")
            self.log("   ____        ___  ____  _____ ____      _  _____ ___ ___  _   _ ")
            self.log("  / ___|      / _ \|  _ \| ____|  _ \    / \|_   _|_ _/ _ \| \ | |")
            self.log(" | |  _ _____| | | | |_) |  _| | |_) |  / _ \ | |  | | | | |  \| |")
            self.log(" | |_| |_____| |_| |  __/| |___|  _ <  / ___ \| |  | | |_| | |\  |")
            self.log("  \____|      \___/|_|   |_____|_| \_\/_/   \_\_| |___\___/|_| \_|")
            self.log("\n      • Selfbot By: G-Operation")
            self.log("      • SB Creator: %s" % self.getContact("uc6e436ae77d2d1f5b5f6bd13ea7b671c").displayName)
            ...
            if uid in ang:pass
               ...
               try:
                  ...
                  self.sendMessage(uid, 'Halo ' + self.getContact(uid).displayName  + ",Thanks for Mini SB:)" )
               except:pass